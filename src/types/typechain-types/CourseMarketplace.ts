...
export interface CourseMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allCourseIds"
      | "buyCourse"
...
export interface CourseMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): CourseMarketplace;
