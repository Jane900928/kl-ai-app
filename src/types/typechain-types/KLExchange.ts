...
export interface KLExchangeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "exchange"
      | "exchangeRate"
...
export interface KLExchange extends BaseContract {
  connect(runner?: ContractRunner | null): KLExchange;
  waitForDeployment(): Promise<this>;

  interface: KLExchangeInterface;
